...
void forward_lite_conv2d_hsp1_sssa8_ch(const ai_i8 *pData_in,
                                            const ai_u16 dim_im_in_x,
                                            const ai_u16 dim_im_in_y,
                                            const ai_u16 n_channel_in,
                                            const ai_i8 *pWeights,
...
void forward_lite_conv2d_hsp2_sssa8_ch(const ai_i8 *pData_in,
                                            const ai_u16 dim_im_in_x,
                                            const ai_u16 dim_im_in_y,
                                            const ai_u16 n_channel_in,
                                            const ai_i8 *pWeights,
...
void forward_lite_conv2d_hsp3_sssa8_ch(const ai_i8 *pData_in,
                                       const ai_u16 dim_im_in_x,
                                       const ai_u16 dim_im_in_y,
                                       const ai_u16 n_channel_in,
                                       const ai_i8 *pWeights,
