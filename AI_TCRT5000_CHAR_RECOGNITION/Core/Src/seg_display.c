...
/**
  * @brief  Configure PB0-PB7 as push-pull outputs for the 7-segment display.
  * @note   The pins are not registered in this project's CubeMX pin table,
  *         so the GPIO clock/config is done here (survives CubeMX regen).
  * @retval None
  */
void SEG_Display_IO_Init(void)
{
