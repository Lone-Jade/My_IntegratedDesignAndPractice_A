...
void
forward_lite_pw_hsp2_sssa8_ch(const ai_i8 *pData_in,
                              const ai_u16 width_in,
                              const ai_u16 height_in,
                              const ai_u16 filt_stride_x,
                              const ai_u16 filt_stride_y,
...
void 
forward_lite_pw_hsp1_sssa8_ch(const ai_i8 *pData_in,
                              const ai_u16 width_in,
                              const ai_u16 height_in,
                              const ai_u16 filt_stride_x,
                              const ai_u16 filt_stride_y,
...
void 
forward_lite_pw_hsp3_sssa8_ch(const ai_i8 *pData_in,
                              const ai_u16 width_in,
                              const ai_u16 height_in,
                              const ai_u16 filt_stride_x,
                              const ai_u16 filt_stride_y,
